          ...
          <Form ref="formstockcard" :model="formstockcard">
            <Row type="flex" justify="center" align="middle">
              ...
              <FormItem :label-width="120">
                ...
                <DatePicker confirm type="daterange" show-week-numbers placement="bottom-center" v-model="formstockcard.dates" placeholder="Select date" style="width: 95%;"></DatePicker>
              </FormItem>
              </Col>
              <Col span="6">
              <FormItem :label-width="60">
                <span slot="label">รายการ:</span>
                <Select v-model="formstockcard.name_rm" :remote-method="remoteMethod1" :loading="loading1" filterable placeholder="ค้นหาวัตถุดิบ" style="width: 100%;">
