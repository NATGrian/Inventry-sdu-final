  ...
  <div class="container-fluid" id="listingredients-container">
    ...
    <Modal v-model="modalshow" title="ข้อมูล วัตถุดิบ" footer-hide width="700" draggable>
      <Row type="flex" justify="space-around" align="middle">
        ...
        <Col span="11">
        <img :src="`/images/materials/${showdata.image}`" alt="">
        </Col>
      </Row>
...
export default {
  ...
  methods: {
    timestamp() {
      ...
      const timestamps = "รายการคงเหลือ วัตถุดิบ " + date + " " + time;
    ...
    confirm() {
      del("/api-inv/ingredients/" + this.deletingID).then((res) => {
        this.$Loading.finish();
