          ...
          <Row type="flex" justify="space-around" align="middle">
            ...
            <Row type="flex" justify="space-around" align="middle">
              ...
              <FormItem :prop="'items.' + index + '.RC_no'">
                ...
                <div style="margin-left: 70px;border-bottom: 1px dotted #000;color: #000;font-size: 12px;">: {{ item.RC_no1 }}</div>
              </FormItem>
              </Col>
              <Col span="6">
              <FormItem :prop="'items.' + index + '.value1'">
                <span slot="label" style="width: 30%;">จาก</span>
                <div style="margin-left: 35px;border-bottom: 1px dotted #000;color: #000;text-align: center;font-size: 12px;"> {{ item.value1 }} / {{item.value2}}</div>
              </FormItem>
              </Col>
              ...
              <FormItem :prop="'items.' + index + '.lot'">
                ...
                <div style="margin-left: 30px;border-bottom: 1px dotted #000;padding-left: 10px;color: #000;">: {{item.LOT_no}}</div>
            ...
            <Row type="flex" justify="space-around" align="middle">
              ...
              <FormItem :prop="'items.' + index + '.products'">
                ...
                <div style="margin-left: 70px;border-bottom: 1px dotted #000;padding-left: 10px;color: #000;">: {{item.products}}</div>
              </FormItem>
              </Col>
            ...
            <Row type="flex" justify="space-around" align="middle">
              ...
              <FormItem :prop="'items.' + index + '.qty'">
                ...
                <Row>
                  <Col span="11" style="border-bottom: 1px dotted #000;color: #000;">
                  : {{item.qty}}
                  </Col>
            ...
            <Row type="flex" justify="space-between" align="middle">
              ...
              <FormItem :prop="'items.' + index + '.member'">
                ...
                <Row>
                  <Col span="24" style="border-bottom: 1px dotted #000;color: #000;">
                  : {{item.member}}
                  </Col>
