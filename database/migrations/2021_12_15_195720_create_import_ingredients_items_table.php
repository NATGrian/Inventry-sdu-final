...
class CreateImportIngredientsItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_ingredients_items', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('import_ingredients_items');
    }
}
